...
If `return_plot` and/or `return_iamges` is set to `TRUE`, cytomapper returns a list object with one or two entries: `plot` and/or `images`.
...
We want to thank the Bodenmiller laboratory for feedback on the package and its functionality.
