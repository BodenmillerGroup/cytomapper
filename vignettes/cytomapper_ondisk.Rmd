...
# Compare the image data to the orginal representation
identical(pancreasImages_inMemory@listData, pancreasImages@listData)
```

```{r sanity-check, echo=FALSE}
stopifnot(identical(pancreasImages@listData, pancreasImages_inMemory@listData))
```
