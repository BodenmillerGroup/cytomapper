...
#'
#' This \linkS4class{ImageList} object contains multi-channel stacks of three images
...
#'
#' This \linkS4class{ImageList} object contains single-channel images representing
