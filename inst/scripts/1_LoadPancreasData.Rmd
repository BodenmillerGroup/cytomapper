...
fn.cells <- ("/Volumes/bbvolume/server_homes/nicolasd/Data/CM2017/mendeley/CellSubset.zip")
unzip(fn.cells)
...
# (Temporary code to unzip the data, will be removed when the Mendeley dataset is public)
fn.images <- ("/Volumes/bbvolume/server_homes/nicolasd/Data/CM2017/mendeley/Image.zip")
unzip(fn.images)
...
# (Temporary code to unzip the data, will be removed when the Mendeley dataset is public)
fn.celltypes <- ("/Volumes/bbvolume/server_homes/nicolasd/Data/CM2017/mendeley/CellTypes.zip")
unzip(fn.celltypes)
...
# (Temporary code to unzip the data, will be removed when the Mendeley dataset is public)
fn.donors <- ("/Volumes/bbvolume/server_homes/nicolasd/Data/CM2017/mendeley/Donors.zip")
unzip(fn.donors)
